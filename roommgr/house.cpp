...
void makeHouse ( char *name, char *password, int hasCrest )
{
	char title[1024];
...
void makeHall ( char *name, char *password )
{
	...
	// let's make a guild hall
	Building *hall = new Building;
	hall->homeTown = random ( _TOWN_LEINSTER_EAST, _TOWN_ARIMATHOR );
}
