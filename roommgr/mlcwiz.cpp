...
// ------------------------ Good Mist Wizard -----------------------------
GoodCastleWizard::GoodCastleWizard() {
}

GoodCastleWizard::~GoodCastleWizard() {
}

void GoodCastleWizard::init( void ) {
...
int GoodCastleWizard::iWantToJump ( WorldObject *thisCharacter ) {
	return ( FALSE );
}

int GoodCastleWizard::spellAttack ( void ) {
	...
	return 1;
}					// ~~~~~ End GoodCastleWizard::spellAttack

// ------------------------ Neutral Mist Wizard -----------------------------
NeutralCastleWizard::NeutralCastleWizard() {
}

NeutralCastleWizard::~NeutralCastleWizard() {
}

void NeutralCastleWizard::init( void ) {
	new MWActionChill ( 0, this );
	new MWActionWander ( 0, this );
	new MWActionChangeRooms ( 0, this );
	new MWActionGroup ( 0, this );
...
int NeutralCastleWizard::iWantToJump ( WorldObject *thisCharacter ) {
	return ( FALSE );
}

int NeutralCastleWizard::spellAttack ( void ) {
	/* Scott: Would prefer the healing done here be by _SPELL_ENIDS_BLESSING */
	/* ----------- Heal myself or test if my group needs healing -----------*/
	int didHeal = partyHeal();
	if (didHeal) return 1;
	...
	return 1;
}					// ~~~~~ End NeutralCastleWizard::spellAttack

// ------------------------ Evil Mist Wizard -----------------------------
EvilCastleWizard::EvilCastleWizard() {
}

EvilCastleWizard::~EvilCastleWizard() {
}

void EvilCastleWizard::init( void ) {
	new MWActionChill ( 0, this );
	new MWActionWander ( 0, this );
	new MWActionChangeRooms ( 0, this );
	new MWActionGroup ( 0, this );
...
int EvilCastleWizard::iWantToJump ( WorldObject *thisCharacter ) {
	return ( FALSE );
}

int EvilCastleWizard::spellAttack ( void ) {
	/* Scott: Would prefer the healing done here be by _SPELL_ENIDS_BLESSING */
	/* ----------- Heal myself or test if my group needs healing -----------*/
	if ( partyHeal() )
		return 1;
	...
	return 1;
}					// ~~~~~ End EvilCastleWizard::spellAttack
